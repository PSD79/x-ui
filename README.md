...
```
bash <(curl -Ls https://raw.githubusercontent.com/PSD79/x-ui/master/install.sh)
```

## Manual install & upgrade

1. First download the latest compressed package from https://github.com/PSD79/x-ui/releases, generally choose `amd64` architecture
